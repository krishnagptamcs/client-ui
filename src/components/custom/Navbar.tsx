      ...
      <nav className="container flex items-center justify-between py-5">
        <div className="flex items-center  gap-5">
          ...
          <Select>
            <SelectTrigger className="w-[180px]">
              <SelectValue placeholder="Select Restraunt" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="chessy">Chessy</SelectItem>
              <SelectItem value="pizza">Pizza hut</SelectItem>
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="hover:text-primary relative">
            ...
            <span className="absolute top-0 left-2 text-xs bg-primary px-1 rounded-full">
              3
            </span>
          </div>
